...
const Footer = () => {
  return (
    <section>
      <div className="mx-auto py-8 px-8 bg-gray-600 grid md:grid-cols-2">
        <article className="">
          <p className="text-3xl font-bold text-sky-600">
            FREYDIER <span className="text-gray-50">Carrelage</span>
          </p>
          <p className="text-gray-50 text-2xl">Votre artisan carreleur</p>
          <p className="text-gray-100 text-lg">Disponible 10h00 - 20h00</p>
          <div>
